                    ...
                    <form method="POST" action="{{ route('user.register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6" style="padding-top: 7px">
                                ...
                                <input class="mr-1" id="gender-m" type="radio" name="gender" value="{{ '男性' }}" required autofocus>

                                <label for="gender-f">女性</label>
                                <input id="gender-f" type="radio" name="gender" value="{{ '女性' }}" required autofocus>
                        ...
                        <div class="form-group row">
                            <label for="company" class="col-md-4 col-form-label text-md-right">{{ __('社名') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="occupation" class="col-md-4 col-form-label text-md-right">{{ __('職種') }}</label>
